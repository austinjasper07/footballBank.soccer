...
export function AdminHeader({ title, subtitle }) {
  ...
  return (
    <header className="border-b border-divider bg-primary-card/30 px-4 py-4 backdrop-blur md:pr-12 md:pl-8 md:py-5">
      <div className="flex items-center justify-between gap-5">
        <div className="min-w-0">
          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary-action">
            FootballBank Admin Console
          </p>
        ...
        <div className="flex shrink-0 items-center gap-2 md:gap-4">
          {/* Notifications */}
          <button
            className="relative inline-flex size-10 items-center justify-center rounded-full border border-divider text-primary-muted transition hover:border-primary-action hover:text-primary-action"
