...
export async function sendWelcomeEmail(payload, firstNameArg) {
  const to = typeof payload === 'object' ? payload.email : payload;
  const firstName = typeof payload === 'object' ? payload.username : firstNameArg;
