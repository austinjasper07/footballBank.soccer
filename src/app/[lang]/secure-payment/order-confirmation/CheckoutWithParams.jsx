...
export default function CheckoutWithParams() {
  ...
  // Use the new shipping calculation system
  const shipping = subtotal >= 50 ? 0 : 5.99
  
  // Tax calculation for physical products: 6.625% Tax
      ...
      <div className="max-w-6xl mx-auto px-4 grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <section className="bg-primary-secondary rounded-2xl border border-divider p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
              ...
              <div>
                <p className="text-primary-muted">Shipping Address</p>
                <p>
                  {selectedAddress ? (
                    <>
                      <span className="font-medium">{selectedAddress.name}</span><br />
        ...
        <div className="space-y-6 sticky top-24">
          <section className="bg-primary-secondary border border-divider rounded-2xl p-8">
            ...
            <BuyNowButton cartItems={items} selectedAddressId={selectedAddressId} />
            <button
