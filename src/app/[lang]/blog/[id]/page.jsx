                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-primary-surface border border-divider p-6">
                      ...
                      <div className="flex space-x-3">
                        ...
                        <a href="https://www.instagram.com/footballbank.soccer" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-linear-to-br from-purple-500 via-pink-500 to-orange-400 text-white rounded-full flex items-center justify-center hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 transition-all">
                          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
