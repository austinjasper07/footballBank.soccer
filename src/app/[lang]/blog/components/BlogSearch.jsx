  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full rounded-md border border-divider bg-primary-card px-4 py-2 pl-10 text-primary-text outline-none transition-all focus:border-primary-action focus:ring-2 focus:ring-primary-action/20 lg:w-64"
        placeholder="Search..."
        aria-label="Search posts"
      />
      <svg
        className="absolute left-3 top-1/2 size-4 -translate-y-1/2 text-primary-muted"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
      ...
      {input ? (
        <button
          ...
          className="absolute top-1/2 right-2 -translate-y-1/2 p-1 text-primary-muted hover:text-primary-text"
          type="button"
        >
          ✕
        </button>
