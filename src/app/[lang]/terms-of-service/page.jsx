  ...
  return (
    <div className="min-h-screen bg-primary-bg text-primary-text">
      ...
      <header className="border-b border-divider bg-primary-card sticky top-0 z-40">
        <div className="max-w-4xl mx-auto px-4 py-4 flex justify-between items-center text-sm text-primary-muted">
          <Link href={`/${lang}`} className="flex items-center gap-2 hover:text-primary-text transition">
      ...
      {/* Hero Section */}
      <section className="bg-primary-surface py-8 md:py-12 border-b border-divider">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 md:py-12">
        {sections.map((section, idx) => (
          <section key={idx} className="mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold text-primary-text mb-1">
              {section.title}
            </h2>
            <p className="text-sm md:text-base text-primary-muted leading-relaxed whitespace-pre-line">
              {section.content}
            </p>
          </section>
        ))}
        ...
        {/* Legal Note */}
        <div className="mt-12 md:mt-16 border-t border-divider pt-6 text-xs md:text-sm text-primary-muted leading-relaxed">
          <p>
