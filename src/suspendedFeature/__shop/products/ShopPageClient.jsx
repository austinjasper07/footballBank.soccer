...
//   <div className="bg-white rounded-lg border border-gray-200 p-3 sm:p-4 animate-pulse">
//     <div className="w-full h-48 sm:h-52 md:h-56 lg:h-48 bg-gray-200 rounded-lg mb-3 sm:mb-4"></div>
//     <div className="h-3 sm:h-4 bg-gray-200 rounded mb-2"></div>
//     <div className="h-3 sm:h-4 bg-gray-200 rounded w-3/4 mb-2 hidden sm:block"></div>
...
//                   >
//                     <div className="relative h-48 sm:h-52 md:h-56 lg:h-48 bg-gray-100 aspect-square sm:aspect-[4/3]">
//                       <Image
//                         src={product.image[0]}
//                         alt={product.name}
//                         fill
...
//                         {product.name}
//                       </h3>
//                       <p className="text-xs text-gray-500 line-clamp-2 mb-2 sm:mb-3 hidden sm:block">
//                         {product.description}
//                       </p>
//                       <div className="flex items-center justify-between mb-2 sm:mb-3">
//                         <span className="text-sm sm:text-lg font-bold text-accent-red">
